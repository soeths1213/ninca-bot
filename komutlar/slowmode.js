...
if (!msg.channel.permissionsFor(msg.member).has("HRR")) return msg.channel.send("Bu komutu sadece `MANAGE_GUILD` yetkisine sahip olanlar kullanabilir.");
...
exports.help = {
  name: 'yavaşmod',
  description: 'Chati slow moda alırsınız.',
  usage: 'slowmode [süre]'
};